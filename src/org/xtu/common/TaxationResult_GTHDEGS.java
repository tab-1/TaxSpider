...
public class TaxationResult_GTHDEGS {
	public String TYPE = "个体户定额公示";
	...
	public String toString() {
		return "TaxationResult_GTHDEGS [TYPE=" + TYPE + ", nsrmc=" + nsrmc + ", nsrsbh=" + nsrsbh + ", sqrq=" + sqrq
				+ ", zsxmMc=" + zsxmMc + ", swjgMc=" + swjgMc + ", gtnsdeHydlMc=" + gtnsdeHydlMc + ", xssr=" + xssr
				+ ", se=" + se + ", gtnsdeHyxlMc=" + gtnsdeHyxlMc + ", hdrqQ=" + hdrqQ + ", hdrqZ=" + hdrqZ
				+ ", szscMc=" + szscMc + ", gsrqZ=" + gsrqZ + "]";
	}	
}